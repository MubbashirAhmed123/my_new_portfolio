        ...
        <div className='sm:flex justify-around'>
          ...
          <div>
            <form className='p-3 text-white' onSubmit={sendEmail}>
              ...
              <br />
              <input type="submit" name="submit" id="" value='Send Email' className='bg-transparent border-2 border-white p-2 rounded-md text-white font-bold cursor-pointer hover:bg-gray-700 hover:text-black transition-all focus:border-blue-700' />
            </form>
          </div>
        </div>
